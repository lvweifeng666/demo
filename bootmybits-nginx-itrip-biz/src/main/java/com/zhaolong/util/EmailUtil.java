...
public class EmailUtil {
    ...
    public static String emailregister(ItripUser user) {
        ...
        try {
            String account = "flyfover35@163.com";            //替换为发件人账号
            String password = "wang123";                    //替换为发件人账号密码
            String receiveMailAccount = "442102937@qq.com";    //替换为收件人账号
            ...
            // 3. 封装Message对象
            MimeMessage message = createMimeMessage(user, session,account, user.getUsercode());
            // 4. 使用Transport发送邮件
